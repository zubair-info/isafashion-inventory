    ...
    <section class="wrapper-invoice">
      ...
      <div class="invoice">
        <div class="invoice-information">
            ...
            <p class="text-uppercase" style="font-size: 22px;"> <b >Chalan Id</b> : #{{ App\Models\CuttingSend::find($cutting_send_id)->send_chalan_id	 }}</p>
          <p><b>Date </b>: {{ App\Models\CuttingSend::find($cutting_send_id)->date}}</p>
        </div>
        <!-- logo brand invoice -->
        ...
        <div class="invoice-body">
          <table class="table" style="width:100%">
            ...
            <tbody>
                ...
                @foreach (App\Models\CuttingMultipleSend::where('cutting_send_id', $cutting_send_id)->get() as $key => $cutting_send_id)
                <tr>
                    <td>{{ $key + 1 }}</td>
                    <td>{{$cutting_send_id->roll}}</td>
                    <td>{{$cutting_send_id->balance}}</td>
