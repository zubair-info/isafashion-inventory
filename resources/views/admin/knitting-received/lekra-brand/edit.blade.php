...
<div class="content container-fluid">				
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">Knitting Received Lekra Edit</h3>
                {{-- <ul class="breadcrumb">
    ...
    <div class="row">
        <div class="col-xl-8 col-sm-12 col-12">
            <div class="card">
                    <div class="card-body">
                        <form action="{{route('KnittingReceivedLekraBrandUpdate')}}" method="post" >
                         @csrf
                         <input type="hidden" name="knitting_received_lekrabrand_id" value="{{ $all_knitting_received_lekrabrand->id}}">
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Send Chalan Id</label>
                                <div class="col-lg-9">
                                    <input type="number" id="send_chalan_id" value="{{ $all_knitting_received_lekrabrand->send_chalan_id}}"  name="send_chalan_id" class="form-control" placeholder="Chalan Id : 11097">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    @foreach ($all_company_name as $company)    
                                        <option value="{{$company->id}}" {{ ( $company->id == $all_knitting_received_lekrabrand->company_id) ? 'selected' : '' }}>{{$company->company_name}}</option>  
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="date"  id="date"  value="{{ $all_knitting_received_lekrabrand->date}}" name="date" class="form-control date">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control lekra_brand"  name="lekra_brand">  
                                        ...
                                        @foreach ($all_lekra_brand_name as $lekra_brand)
                                            <option value="{{$lekra_brand->id}}" {{ ( $lekra_brand->id == $all_knitting_received_lekrabrand->lekra_brand_id)? 'selected' : '' }}>{{$lekra_brand->lekra_brand_name}}</option>  
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" step="any"  value="{{ $all_knitting_received_lekrabrand->lekra_cartoon}}" class="form-control lekra_cartoon" name="lekra_cartoon"  placeholder="Enter Lekra Cartoon : 10" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" step="any"  class="form-control lekra_rate" value="{{ $all_knitting_received_lekrabrand->lekra_cartoon}}" name="lekra_rate"  placeholder="Enter Lekra Rate : 27.36">
