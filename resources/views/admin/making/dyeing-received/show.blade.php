                               ...
                               @foreach ($all_dyeing_received as $key=>$dyeing_received)   
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-left">                                              
                                                <div class="actions">
                                                    <a  class="btn btn-sm bg-success-light"  href="{{route('dyeingSendView',$dyeing_received->id)}}">
                                                        <i class="fe fe-eye"></i> View
                                                    </a>
                                                    <a  class="btn btn-sm bg-info-light" target="_blank" href="{{route('dyeingSendPDFView',$dyeing_received->id)}}">
