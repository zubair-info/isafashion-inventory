    ...
    <section class="wrapper-invoice">
      ...
      <div class="invoice">
        <div class="invoice-information">
          <p><b>Send Chalan Id#</b> :{{ App\Models\MakingKnittingReceived::find($knitting_received_id)->send_chalan_id }}</p>
          ...
          <table class="table" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$knitting_received_id->weight}}</td>
                    <td>{{$knitting_received_id->cartoon}}</td>
                    <td>{{$knitting_received_id->rate}}</td>
                    <td>{{$knitting_received_id->rel_to_lekra_brand->lekra_brand_name}}</td>
                    <td>{{$knitting_received_id->lekra_cartoon}}</td>
                    <td>{{$knitting_received_id->lekra_rate}}</td>
                    <td>{{$knitting_received_id->rel_to_company->company_name}}</td>
